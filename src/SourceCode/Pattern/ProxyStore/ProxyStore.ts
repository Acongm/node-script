...
export type ProxyStoreSubscriber<T = any> = (value: T, key: string, prevValue: T) => void;
 ...
 * 创建类型安全的 ProxyStore
 */
export function createProxyStore<T extends object>(initialState?: T): ProxyStore<T> {
